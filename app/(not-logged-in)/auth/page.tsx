    ...
    <div className='bg-slate-800 text-slate-50 h-screen grid grid-cols-2'>
      ...
      <div className='authentication-section flex items-center justify-start ml-20'>
        <div className='w-1/3'>
          ...
          <div className="flex items-center gap-1 before:content-[''] before:block before:flex-1 before:h-0.5 before:bg-slate-100 before:opacity-50 after:content-[''] after:block after:flex-1 after:h-0.5 after:bg-slate-100 after:opacity-50">
            or
          </div>
          <div className='signup-section'>
            <div className='bg-sky-600 flex w-full h-10 rounded-full items-center justify-center cursor-pointer hover:opacity-80 my-4'>
              <div className='flex justify-center items-center'>
                <Link href='/auth/signup' className='text-slate-50 text-base'>
                  Create account.
                </Link>
              </div>
            </div>
            <p className='text-xs'>
              By signing up, you agree to the <span className='text-sky-400'>Terms of Service</span>{' '}
              and <span className='text-sky-400'>Privacy Policy</span>, including{' '}
              <span className='text-sky-400'>Cookie Use</span>.
            </p>
          </div>
          <div className='login-section mt-10'>
            ...
            <div className='flex w-full h-10 rounded-full items-center justify-center cursor-pointer hover:opacity-80 hover:bg-sky-900 my-4 border-slate-50 border'>
              <div className='flex justify-center items-center'>
                <Link href='/auth/login' className='text-blue-200 text-base'>
                  Sign in
                </Link>
              </div>
            </div>
