...
const VerificationForm: React.FC<VerificationFormProps> = ({ state }) => {
      ...
      <form className='mt-3 h-96 flex flex-col justify-between'>
        <div>
          <input
            ...
            className='bg-neutral-900 placeholder:text-slate-600 px-4 rounded border-slate-500 border w-full h-12 focus:outline-none focus:border-3 focus:border-sky-500 mt-3'
          />
