        ...
        <div className='search-section flex py-2'>
          ...
          <div className='search-form h-full w-64 ml-4 bg-slate-700 rounded-full flex px-4 relative'>
            <FontAwesomeIcon
              ...
              className='text-slate-400 text-lg top-0 absolute translate-y-2.5'
            />
            <input
              type='text'
              className='ml-6 rounded-full placeholder:text-slate-400 bg-slate-700 h-full w-full focus:outline-none'
